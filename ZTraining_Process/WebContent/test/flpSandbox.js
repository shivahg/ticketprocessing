		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Training",
									"targetURL": "#zhrtrainingzhrtraining-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zhrtrainingzhrtraining-display": {
								"semanticObject": "zhrtrainingzhrtraining",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zhrtraining.zhrtraining",
									"url": sap.ui.require.toUrl("zhrtraining/zhrtraining")
								}
							}
						}
					}
